...
import { 
  ...
  LogOut, ChevronLeft, Menu, Hash, Database,
      ...
      <motion.aside animate={{ width: isCollapsed ? 88 : 300 }} className="relative border-r border-white/5 bg-slate-950/40 backdrop-blur-2xl flex flex-col z-50 transition-all duration-300">
        ...
        <nav className="flex-1 px-4 space-y-2 overflow-y-auto no-scrollbar scroll-smooth">
          ...
          <div className="pt-6 pb-2 border-t border-white/5 mt-4">
             {!isCollapsed && <p className="px-4 text-[9px] font-black uppercase text-white/20 mb-4 tracking-[0.3em]">Evaluation Lab</p>}
             <NavItem icon={<CheckSquare size={20} />} label="Approval" collapsed={isCollapsed} />
             <NavItem icon={<Eye size={20} />} label="Project Preview" collapsed={isCollapsed} />
          </div>
        ...
        <div className="p-10 pb-8 bg-gradient-to-b from-[#010208] via-[#010208] to-transparent z-40">
          <div className="max-w-6xl mx-auto space-y-8">
            <header>
              ...
              <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] mt-3">Institutional Review & Pooling Phase</p>
            </header>

            {/* Global Filtering Tools */}
            <div className="flex flex-col xl:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full group">
                ...
                <input 
                  ...
                  placeholder="Identify research for review or discovery..."
...
// --- Sub-Components (Filters, Cards, Nav) ---
...
const ProjectCard = ({ title, author, dept, year, program, keywords }: any) => (
  <motion.div layout initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-slate-950/40 border border-white/5 p-12 rounded-[48px] hover:border-orange-500/20 transition-all group relative overflow-hidden ring-1 ring-white/5">
